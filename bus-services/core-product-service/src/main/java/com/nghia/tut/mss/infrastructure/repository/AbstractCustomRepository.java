...
public abstract class AbstractCustomRepository<E extends AbstractEntity, ID> extends SimpleJpaRepository<E, ID> {

    protected EntityManager entityManager;

    public AbstractCustomRepository(Class<E> domainClass, EntityManager em) {
